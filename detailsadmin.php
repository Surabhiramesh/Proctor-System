        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="infoadmin.php"> <i class="menu-icon fa fa-dashboard"></i>Student List</a>
                    </li>
                    <h3 class="menu-title">Academic Details</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="infoadmin.php" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Personnel Information </a>
                    <li class="menu-item-has-children dropdown">
		...
		<center>
			 ...
			 <form>
                        ...
                        <div class="card-header">
                            <strong class="card-title"><h2>Personnel Details<?php $_SESSION["cur_sess"] = $_GET['id']; echo $_SESSION["cur_sess"]; ?></h2></strong>
                        </div>
