...
echo $_POST['pr_meet1_agenda'];
 ...
 $sql = "UPDATE meet_sem4 SET academic_yr = '$academic_yr', pr_meet1_agenda = '$pr_meet1_agenda', pr_meet1_date = '$pr_meet1_date', pr_meet1_issues = '$pr_meet1_issues',pr_meet1_actiontaken = '$pr_meet1_actiontaken',
