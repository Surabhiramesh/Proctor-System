...
$sql = "SELECT * from meet_sem1 where USN='".$_SESSION['cur_sess']."'";
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
			...
			<form method="post" action="update_meet1.php" target="hiddenFrame">
	<center>
...
<tr>
	 ...
	 <td> <input type="text" size="55" name="pr_meet1_agenda" value="<?php echo $row["pr_meet1_agenda"];?>"></td>
	 </tr>
<tr>
	 <td>Date</td>
...
<table>
<tr>
	 <td rowspan="1">Agenda:</td><td><input size="55" type="text" name="pr_meet2_agenda" value="<?php echo $row["pr_meet2_agenda"];?>"></textarea></td>
	 </tr>
<tr>
	 <td>Date</td>
