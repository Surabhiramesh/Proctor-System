...
$sql = "SELECT * from meet_sem8 where USN='".$_SESSION['cur_sess']."'";
...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   ...
                   <li class="menu-item-has-children dropdown">
                        <a href="info.html" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Personnel Information </a>
                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
			...
			<form method="post" action="update_meet8.php" target="hiddenFrame">
	<center>
