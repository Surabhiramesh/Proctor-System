...
$sql = "SELECT USN,Name,Phone,Email FROM student s,proctor p where s.Pid=p.Fid and s.Pid='".$_SESSION['fid']."'";
...
<body>
 ...
 <?php
						...
						<tr>
							...
							<td> <a href="details.php?id=<?php echo $row["USN"];?>" >Click Here </a> </td>
						</tr>
						<?php } }  ?>
